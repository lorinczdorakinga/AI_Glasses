        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (data.isLoading && data.summary.summary.isEmpty)
                const Padding(
                  ...
                  child: RadarChart(
                    RadarChartData(
                      dataSets: [
                        RadarDataSet(
                          dataEntries: [
                            RadarEntry(value: data.summary.radarValue('focus')),
                            RadarEntry(value: data.summary.radarValue('consumption')),
                            RadarEntry(value: data.summary.radarValue('activity')),
                            RadarEntry(value: data.summary.radarValue('social')),
                            RadarEntry(value: data.summary.radarValue('explore')),
                          ],
                      ...
                      getTitle: (index, angle) {
                        const titles = ['Focus', 'Consumption', 'Activity', 'Social', 'Explore'];
              ...
              GestureDetector(
                onTap: () => setState(() => _isImageRevealed = !_isImageRevealed),
                child: Container(
                  height: 220,
                  width: double.infinity,
                  decoration: BoxDecoration(
                        ...
                        Container(
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              ...
                              colors: [Colors.teal.shade300, Colors.blueGrey.shade800],
                            ),
                          ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      data.summary.summary.isNotEmpty
                          ? data.summary.summary
                          : 'Waiting for your first activity data…',
